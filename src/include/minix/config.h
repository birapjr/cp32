 ...
 *===========================================================================*/
#define MACHINE           CARDPUTER_ADV	/* Must be one of the names listed below */
...
#define CARDPUTER_ADV     63  /* M5Stack Cardputer Adv (ESP32-S3) */
...
#define ESP32_S3          4 /* CHIP type for Cardputer Adv              */
